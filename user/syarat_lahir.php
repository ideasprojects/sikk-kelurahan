...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper">
    <div class="box box-default">
      ...
      <!-- form start -->
      <form method="post" enctype="multipart/form-data" action="upload_syaratlahir.php">
        <div class="box-body">
          <div class="form-group">
           ...
           while($d = mysqli_fetch_array($data)){
             ...
             <input type="text" class="form-control" name="id_kel" value="<?php echo $d['id_kel']; ?>" readonly="readonly"> 
             <!-- Id Kelahiran -->
             <input type="hidden" name="idkel" value="<?= $idl; ?> ">
             <?php
           }
           ?> 
           ...
           <select class="form-control" name="nama_dok" required="">
            ...
            <option value="Fotokopi Kutipan Akta Nikah" >Fotokopi Kutipan Akta Nikah</option>
            <option value="Fotokopi Surat Ket.Kelahiran dari Rumah Sakit" >Fotokopi Surat Ket.Kelahiran dari Rumah Sakit</option>
          </select>
          ...
          <tr>
            ...
            while($d = mysqli_fetch_array($data)){
              ...
              <tr>
                ...
                <td>
                  <a href="hapus_syaratlahir.php?id_kel=<?php echo $d['id_kel']; ?>&nmr_dok=<?php echo $d['nmr_dok']; ?>" class="fa fa-trash-o" >Hapus</a>           
                </tr>
