    ...
    <div class="content-wrapper">
      <div class="box box-default">
        ...
        while($d = mysqli_fetch_array($data)){
          ?>
          <!-- form start -->
          <form method="post" enctype="multipart/form-data" action="update_kk.php">
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                   <label>No KK</label>
                   <input type="text" class="form-control" name="no_kk" value="<?php echo $d['no_kk']; ?>" required=""
                   data-inputmask="'mask': ['9999-9999-9999-9999']" data-mask readonly="">
                   <label>Nama Kepala Keluarga</label>
                   <input type="text" class="form-control" name="kepala_keluarga" value="<?php echo $d['kepala_keluarga']; ?>" required="">
                   <label>Alamat</label>
                   <input type="text" class="form-control" name="alamat" value="<?php echo $d['alamat']; ?>" required="">
                   <label>RT/RW</label>
                   <input type="text" class="form-control" name="rtrw" value="<?php echo $d['rtrw']; ?>" data-inputmask="'mask': ['999-999']" data-mask required="">
            ...
            <div class="form-group">
              ...
              <input type="file" name="file_kk" > <span><?php echo $d['file_kk'];?></span>
