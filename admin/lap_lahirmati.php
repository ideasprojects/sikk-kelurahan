						...
						<div class="box-body">
							<table id="example1" class="table table-bordered">
								...
								<tbody>
									...
									$data = mysqli_query($koneksi,"SELECT * FROM kelahiran WHERE status='2' ORDER BY tgl_ajuan ASC");
							...
							<div class="box-body">
								<table id="example2" class="table table-bordered">
									...
									<tbody>
										...
										<?php 
										$data = mysqli_query($koneksi,"SELECT * FROM kematian WHERE status='2' ORDER BY tgl_ajuan ASC");
										while($d = mysqli_fetch_array($data)){
											?>
											<tr>
