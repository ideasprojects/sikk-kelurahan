  ...
  <div class="content-wrapper">
    <div class="box box-default">
      ...
      while($d = mysqli_fetch_array($data)){
        ...
        <!-- form start -->
        <form method="post" action="input_ketmati.php">
          <div class="box-body">           
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" value="<?php echo $d['nama_alm']; ?>" disabled>
                  <label>ID Surat Kematian</label>
                  <input type="text" class="form-control" value="<?php echo $d['id_kem']; ?>" disabled>
                  <!-- Id Kelahiran -->
                  <input type="hidden" name="id_kem" value="<?= $idm; ?> ">
                  <label>Keterangan</label>
                  <input type="text" class="form-control" name="ket" value="<?php echo $d['ket']; ?>"><br>
